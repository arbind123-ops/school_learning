...
class HomeView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        arr = [teacher.user.username for teacher in teachers]
        for teacher_name in bubble_sort(arr):
            teachers_list = [teachers.get(user__username = teacher_name) for teacher_name in arr]
